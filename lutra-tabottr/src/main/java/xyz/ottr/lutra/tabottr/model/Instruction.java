...
public abstract class Instruction {
    ...
    protected List<String> getRow(int rowIndex, int[] colIndices) {
        ...
        if (rowIndex < this.rowStart || rowIndex > this.rowEnd) {
            throw new IndexOutOfBoundsException("Error getting row with index: " + rowIndex
            + ". Index must be between " + this.rowStart + " and " + this.rowEnd + ".");
        }
